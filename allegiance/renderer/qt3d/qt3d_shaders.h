...
void main()
{
    ...
    gl_Position = projectionMatrix * mat4(mat3(viewMatrix)) * modelMatrix * vec4(vertexPosition, 1.0);
}
)";
...
constexpr std::string_view focus_area_vs = R"(
#version 150 core
...
constexpr std::string_view focus_area_ps = R"(
#version 150 core
